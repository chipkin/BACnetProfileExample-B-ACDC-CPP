...
// (Object_Identifier, Object_Type, Status_Flags, Reliability, Object_List,
// Protocol_*). Event_State is NOT generated - with no alarming configured it
// simply reads its datatype default of normal(0), correct by coincidence, not
// because the stack computes it. The handful the application must supply are served by
